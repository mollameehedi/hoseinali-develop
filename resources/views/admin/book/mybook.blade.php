    ...
    <div class="sl-pagebody">
      <div class="sl-page-title">
        ...
        <div class="container">
            ...
            @endif
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <img src="{{ asset('uploads/books/') }}/{{ $book->book_photo }}" alt="{{ $book->book_photo }}" style="height: 150px" class="img-fluid">
                    </td>
                    <td><a href="{{ route('my.book.delete',$book->id) }}" class="btn btn-danger">Delete</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
          ...
          @endif
                  <div class="card-body">
                   <form method="post" action="{{ route('my.book.store') }}" enctype="multipart/form-data">
                     @csrf
